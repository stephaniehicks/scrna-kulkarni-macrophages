...
salmon index -t /fastscratch/myscratch/shicks1/scrna-kulkarni-macrophages/salmon_index_files/gentrome_transcripts_mouse.fa.gz \
             ...
             -i /fastscratch/myscratch/shicks1/scrna-kulkarni-macrophages/salmon_index_files/gencode.vM25-salmon-index-v1.0.0-mouse-withdecoys \
             --gencode --threads 4 -k 31

# # create salmon index without decoys (this process takes <30 mins for mouse)
# salmon index -t /fastscratch/myscratch/shicks1/scrna-kulkarni-macrophages/salmon_index_files/gencode.vM25.transcripts.fa.gz \
